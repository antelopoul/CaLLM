...
def parse_args():
    ...
    parser.add_argument("--prompt", default="Is there anything abnormal in the video?", help="Ask a question")
...
if __name__== "__main__":
    print('DO NOT FORGET TO UPDATE THE VIDEO PATH')
...
def upload_video(gr_video, gr_img, text_input, chat_state,chatbot):
    ...
    if gr_img is None and gr_video is None:
        ...
        chat_state.system =  "You are able to understand the visual content that the user provides. Follow the instructions carefully and explain your answers in detail.\
            You are a surveiliance assistant which can determine if there is \
    anything suspicious or malicious item or/and movement in a video. Answer the questions in binary form (Yes/No) limited in 3 characters."
        img_list = []
...
directory='/home/student.aau.dk/fd27ct/projects/VAD/LearningNotToReconstructAnomalies/dataset/avenue/testing/frames'

if os.path.isdir(directory):
    for folder in range(1, 22):
...
# directory = input('Enter video dataset: ')
